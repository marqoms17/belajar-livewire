<div class="w-1/4 my-10">
    <div class="py-2">
        <div class="mx-auto">
            <h2 class="mt-2 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Create New User</h2>
        </div>
        ...
        <div class="mt-4">
            ...
            <form wire:submit.prevent="createNewUser" action="#" method="POST" class="space-y-6">
                ...
                <div class="col-span-full">
                    <label for="profile-picture" class="block text-sm/6 font-medium text-gray-900">Profil
                        Picture</label>
